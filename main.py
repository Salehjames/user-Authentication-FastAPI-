...
SECRET_KEY = "4d6be2860e4ae5e7e286b8ff685c37dcf8b0358d217ce7150c30c0493113297"
ALGORITHM = "HS256"
...
db = {
    "name": {
        "username": "James",
        "full_name": "James Saleh",
        "email": "james@gmail.com",
        "hashed_password": "$2b$12$163P1Lg16aMThwZ1QK9VPOD184t.TnkGngRophRjt/w8/c34r01nW",
        "disabled": False
    }
}
...
async def get_current_user(token: str = Depends(oauth2_scheme)):
    credential_exception = HTTPException(status_code=status.HTTP_401_UNAUTHORIZED,detail="could not validate credentails", header={"WWW-Authenticate": "Bearer"})
    try:
